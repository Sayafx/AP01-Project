...
Shader "Shader Forge/L11SF" {
    Properties {
        ...
        _DiffuseInt ("DiffuseInt", Range(1, 3)) = 1.3
    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                ...
                UNITY_DEFINE_INSTANCED_PROP( float, _DiffuseInt)
...
////// Emissive:
                ...
                float _DiffuseInt_var = UNITY_ACCESS_INSTANCED_PROP( Props, _DiffuseInt );
                ...
                float3 node_8828 = (((node_6867*saturate(dot(node_6347.rgb,lightDirection)))*_DiffuseInt_var)+(((node_6867*(_SpecTex_var.a*node_9694))+(node_9694*_SpecTex_var.b))*_SpecInt_var)); // 直射光
